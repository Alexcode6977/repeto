...
import { useListen, type ListenMode, type OpenAIVoice } from "@/lib/hooks/use-listen";
...
export function ListenMode({
    ...
    useEffect(() => {
        const fetchCapabilities = async () => {
            try {
                ...
                // If not premium and mode requires it, reset
    ...
    return (
        <div className="fixed inset-0 flex items-center justify-center z-50 bg-background/98">
            {/* Background glow */}
            <div className="absolute inset-0 bg-gradient-radial from-cyan-500/5 via-transparent to-transparent opacity-50 pointer-events-none" />
            ...
            <div className="w-full h-[100dvh] md:h-[85vh] md:max-w-3xl md:rounded-3xl md:border md:border-border md:shadow-2xl md:bg-background/40 md:backdrop-blur-sm flex flex-col overflow-hidden bg-transparent text-foreground relative">
                ...
                <div className="flex-none flex justify-between items-center p-4 md:p-6 z-10">
                    <div className="flex items-center gap-3">
                        <div className="px-3 py-1.5 rounded-full text-[10px] font-bold uppercase tracking-widest border bg-cyan-500/10 text-cyan-400 border-cyan-500/30 flex items-center gap-2">
                        ...
                        return (
                            ...
                            >
                                ...
                                <p className={cn(
                                    ...
                                    isUser && isActive ? "text-cyan-600 dark:text-cyan-300 drop-shadow-md" : ""
                                )}>
                                    {isActive && status === "playing" && (
                                        <span className="inline-block w-2 h-2 rounded-full bg-cyan-500 animate-pulse mr-3 align-middle" />
                                    )}
                                    {line.text}
                                </p>
                            </div>
                ...
                <div className="flex-none pb-8 md:pb-12 pt-4 px-6 md:px-8 flex items-center justify-between relative z-30">
                    ...
                    <div className="relative group">
                        ...
                        <div className={cn(
                            ...
                            status === "playing"
                                ? "bg-cyan-500 opacity-40 scale-150"
                                : "bg-cyan-500 opacity-0 scale-100"
                        )} />
                        ...
                        <button
                            ...
                            className={cn(
                                ...
                                status === "playing"
                                    ? "bg-cyan-500 border-cyan-400 scale-110 shadow-[0_0_50px_rgba(6,182,212,0.6)]"
