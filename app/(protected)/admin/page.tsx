...
import { ArrowLeft, CheckCircle, Clock, MessageSquare, Star, Filter, ChevronDown, ChevronUp, Save, Loader2, AlertCircle } from "lucide-react";
import { cn } from "@/lib/utils";
import { getAllFeedback, updateFeedbackStatus, getFeedbackStats, isAdmin } from "./actions";
    ...
    return (
        <div className="w-full max-w-6xl mx-auto space-y-6 pb-20">
            ...
            <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-2xl font-bold text-white">Admin - Feedbacks Beta</h1>
                    <p className="text-sm text-gray-400">Gérer les retours utilisateurs</p>
                </div>
            </div>
