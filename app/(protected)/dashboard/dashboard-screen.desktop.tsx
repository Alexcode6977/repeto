...
export function DashboardScreenDesktop(props: DashboardHomeRendererProps) {
    return (
        <div className="max-w-7xl mx-auto min-h-screen relative pt-24 pb-12">
            <div className="px-6 md:px-12 mb-6">
                <DashboardHeader {...props} forceVariant="desktop" />
            </div>
            ...
            <div className="px-6 md:px-12 animate-in fade-in zoom-in duration-500">
                ...
                <ScriptGrid {...props} forceVariant="desktop" />
            </div>
        </div>
    );
}
