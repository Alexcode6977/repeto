        ...
        <div className="space-y-10">
            ...
            <div className="flex flex-col gap-4 relative">
                ...
                <Link
                    ...
                    className="flex items-center gap-2 text-sm text-gray-500 hover:text-white transition-colors group w-fit relative"
                >
            ...
            <div className="grid gap-6">
                {feedbacks.length === 0 ? (
                    <div className="p-20 text-center rounded-3xl bg-white/5 border-2 border-dashed border-white/5">
                        <MessageSquare className="w-12 h-12 text-gray-800 mx-auto mb-4" />
                        <p className="text-gray-500 font-bold text-lg">Aucun retour pour le moment.</p>
                        <p className="text-gray-600 text-sm">Ils apparaîtront ici après vos prochaines répétitions.</p>
                    </div>
                ) : (
                    feedbacks.map((fb: any) => (
                        <Card key={fb.id} className="bg-white/5 border-white/10 backdrop-blur-md rounded-3xl overflow-hidden group hover:border-primary/20 transition-all">
                            <CardHeader className="p-6 pb-0 border-b-0">
                                <div className="flex justify-between items-start">
                                    ...
                                    <Badge variant="outline" className="rounded-full px-3 py-1 bg-white/5 border-white/10 text-gray-400 text-[10px] uppercase font-bold tracking-widest">
